...
var camera = new THREE.OrthographicCamera(
  window.innerWidth / 2,
  -window.innerWidth / 2,
  window.innerHeight / 2, // 屏幕宽度/屏幕高度
...
// const earthTexture_sun = textureLoader.load('/src/assets/sun.jfif'); // 替换为你的地球纹理图片路径

// const material_sun = new THREE.MeshPhongMaterial({
//     map: earthTexture_sun,
//     emissiveIntensity: 0.15, // 发射光的强度
//     shininess: 100
// });
// const sphere = new THREE.Mesh(geometry, material_sun);
...
// 创建一个“局部场景”来包含地球和月球
const localScene = new THREE.Group();
const orbitRadius =800; // Distance from sun to earth
// 地球
// 加载地球纹理
...
const earthGroup = new THREE.Mesh(geometry_earth, material_earth);
...
const moonGroup = new THREE.Mesh(geometry_moon, material_moon);
